...
const CrushConfessionAI = () => {
    ...
    const handleConfession = () => {
        ...
        setTimeout(() => {
            alert(submittedInput);
            setResponse(`We think "${submittedInput}" is quite adorable!`);
            setIsTyping(false);
        }, 2000);
    };
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg space-y-4">
                ...
                <div className="flex items-center">
                    ...
                    <button
                        ...
                        className="bg-gray-800 text-white px-8 py-4 rounded-md flex items-center justify-center hover:bg-blue-600 transition duration-200 ml-2"
                        disabled={!input.trim()}
                    >
